...
#     --output_path examples/output/grandma/
...
python gaussianavatars/train.py \
    ...
    --source_paths examples/output/grandma/reference_images/ examples/output/grandma/generated_images/ \
    --model_path examples/output/grandma/avatar/
...
python gaussianavatars/animate.py \
    ...
    --output_path examples/output/grandma/animation_01/ \
    --export_ply 1 \
    --compress_ply 0
